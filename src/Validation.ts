...
export function validateDataShape<T extends Shape>(params: {
	...
	try {
		validateDataShapeAux(params.data, params.shape, [])
	} catch (error) {
...
export function validateDataShapeAux<T extends Shape>(data: any, shape: T, path: Array<string | number>) {
